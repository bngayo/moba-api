...
export default () => {
  ...
  return (
    <div className="flex items-center justify-between w-full p-4 text-sm bg-white border-b md:py-0 md:px-12 d:text-md">
      <div className="mt-1 mr-4 text-3xl font-weight-bold text-green-900">
        Maseno Old Boys Association
      </div>
      <div className="relative">
        ...
        >
          <div className="mr-1 text-gray-800 whitespace-nowrap group-hover:text-red-600 focus:text-red-600">
            ...
            <span className="hidden ml-1 md:inline"></span>
          </div>
          <Icon
            className="w-5 h-5 text-gray-800 fill-current group-hover:text-red-600 focus:text-red-600"
            name="cheveron-down"
          />
        </div>
